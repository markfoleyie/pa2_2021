...
class Student(Base):
    ...
    student_no = Column(String, primary_key=True)
...
class Module(Base):
    ...
    mod_code = Column(String, primary_key=True)
    name = Column(String)
...
class StudentModule(Base):
    ...
    student_no = Column(String, ForeignKey("student.student_no"), primary_key=True)
    mod_code = Column(String, ForeignKey("module.mod_code"), primary_key=True)
